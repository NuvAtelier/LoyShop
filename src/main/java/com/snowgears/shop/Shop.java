...
import com.snowgears.shop.hook.LandsHookListener;
import com.snowgears.shop.hook.WorldGuardConfig;
...
public class Shop extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Initialisation du hook Lands uniquement
        if(getServer().getPluginManager().getPlugin("Lands") != null){
            landsHookListener = new LandsHookListener(this);
            getServer().getPluginManager().registerEvents(landsHookListener, this);
            this.getLogger().notice("Lands est installé, création du listener Lands");
        }

        // Initialiser WorldGuardConfig
        worldGuardConfig = new WorldGuardConfig();

        // Initialiser BluemapHookListener si nécessaire
    ...
    public void reload(){
        ...
        if(landsHookListener != null){
            HandlerList.unregisterAll(landsHookListener);
        }
